...
export const inline = () => {
  ...
  >
    <qti-assessment-item identifier="blah" ${ref(assessmentItemRef)}>
...
export const woordmars = () => {
  ...
  return html`
    ...
    >
      <qti-assessment-item identifier="blah" 2 ${ref(assessmentItemRef)}>
        <qti-response-declaration identifier="RESPONSE" cardinality="single" base-type="identifier">
          <qti-correct-response>
...
export const kringloop = () => {
  ...
  return html`
    ...
    >
      <qti-assessment-item identifier="kringloop1" ${ref(assessmentItemRef)}>
            ...
            <div class="qti-layout-col12">
              ...
              <div>
                ...
                <qti-feedback-block
                  ...
                  show-hide="show"
                >
                  Dat is niet goed, gelukkig is het minder, maar toch 562 kilo! Dat is net zoveel als het gewicht van
                  een groot paard!🐎
                </qti-feedback-block>
              </div>
            </div>
